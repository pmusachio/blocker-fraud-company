"""Command line interface for the fraud detection workflow."""
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run the fraud detection workflow.")
    ...
    sub.add_parser("train", help="Train the fraud classifier and write metrics/model artifacts")
